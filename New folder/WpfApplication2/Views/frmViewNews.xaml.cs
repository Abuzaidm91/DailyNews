...
namespace DailyNews.Views
{
    ...
    public partial class frmViewNews : Window
    {
        ...
        public static readonly DependencyProperty ListLengthProperty =
            DependencyProperty.Register("ListLength", typeof(int), typeof(Window), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty selectedOneProperty =
            DependencyProperty.Register("selectedOne", typeof(int), typeof(Window), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty CurrnetNewsProperty =
            DependencyProperty.Register("CurrnetNews", typeof(int), typeof(Window), new PropertyMetadata(null));
