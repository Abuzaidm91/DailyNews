...
namespace DailyNews.Views
{
    ...
    public partial class frmAddUpdatesSocialMedia : Window
    {
        ...
        private void AddImage_MouseDown(object sender, RoutedEventArgs e)
        {
            ...
            {
                SocialMediaPost_NotReflected.Image.Add(File.ReadAllBytes(openFileDialog.FileName));
            }
        ...
        {
            DataBaseManager.InsertOrUpdateSocialMediaPost(SocialMediaPost_NotReflected);
        }
        ...
        {
            Image DeleteButtonSender = (Image)sender;
            SocialMediaPost_NotReflected.Image.Remove((byte[])DeleteButtonSender.DataContext);        
            this.Images.ItemsSource = null;
            this.Images.ItemsSource = SocialMediaPost_NotReflected.Image;
        }
    }
